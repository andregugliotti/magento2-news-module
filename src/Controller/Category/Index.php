 ...
 * Gugliotti News
 */
namespace Gugliotti\News\Controller\Category;
 ...
 * Class Index
 *
 * Gugliotti News Category Index Controller.
 * @author Andre Gugliotti <andre@gugliotti.com.br>
 * @version 0.1.0
 * @license GNU General Public License, version 3
 * @package Gugliotti\News\Controller\Category
 */
class Index extends Action
{
    ...
    public function execute()
    {
        ...
        $page->getConfig()->getTitle()->set((__('News | All Categories')));
        return $page;
    }
}
